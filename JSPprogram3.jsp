/*3: Validate User input entered in a form. The input must include
Name, DOB, Email ID, Lucky Number, Favorite food etc.
*/
...
<html>
<head>
	<title>JSP program3 Tutorialsduniya.com</</title>
</head>
<body bgcolor="white">
